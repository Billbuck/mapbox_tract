...
window.FRANCE_MODULE_CONFIG = {
    ...
    SCRIPTS_BASE_PATH: '/RepWeb/js/',
    CSS_BASE_PATH: '/RepWeb/css/',
...
var scriptsToLoad = [
    ...
    // Modules principaux
    'zecible-ui-manager.js',
    'zecible-map-manager.js',
    'zecible-zones-loader.js',
    'zecible-selection-tools.js',
    'zecible-import-manager.js',
	'zecible-search-manager.js',
	'zecible-labels-manager.js',
...
debugLog('entete', '✅ zecible-bdd.js chargé - En attente du chargement des ressources...');